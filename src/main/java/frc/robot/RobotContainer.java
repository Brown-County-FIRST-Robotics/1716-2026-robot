  ...
  private void configureButtonBindings() {
    ...
    drive.setDefaultCommand(
        DriveCommands.joystickDrive(
            drive,
            () -> -controller.getLeftY() / (opcon.rightTrigger().getAsBoolean() ? 4 : 1),
            () -> -controller.getLeftX() / (opcon.rightTrigger().getAsBoolean() ? 4 : 1),
            () -> -controller.getRightX() / (opcon.rightTrigger().getAsBoolean() ? 4 : 1)));
