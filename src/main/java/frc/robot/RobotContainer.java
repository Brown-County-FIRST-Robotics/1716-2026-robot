...
public class RobotContainer {
  ...
  public RobotContainer() {
    SmartDashboard.putNumber("Hood Servo", 2);
    SmartDashboard.putNumber("Shooter RPS", 105);
    SmartDashboard.putNumber("Kicker RPS", 20);
  ...
  private void configureButtonBindings() {
    ...
    controller
        ...
        .whileTrue(
            Commands.run(
                () -> shooter.quickServoCommand(SmartDashboard.getNumber("Hood Servo", 0)),
                shooter));
    ...
    controller
        ...
        .whileTrue(
            Commands.run(
                    () -> shooter.setShooterSpeed(SmartDashboard.getNumber("Shooter RPS", 0)),
                    shooter)
                .alongWith(
                    Commands.waitSeconds(1.0)
                        .andThen(
                            Commands.run(
                                () ->
                                    rollers.setSpeeds(0, SmartDashboard.getNumber("Kicker RPS", 0)),
                                rollers)))
                .alongWith(
                    Commands.race(
