...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    // opcon.rightBumper().whileTrue(intake.extendHopperVelocity());
    // opcon.leftBumper().whileTrue(intake.retractHopperVelocity());
    opcon.rightBumper().onTrue(intake.extendHopper());
    opcon.leftBumper().onChange(intake.retractHopper());
