...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    opcon.rightBumper().onTrue(intake.extendHopperVelocity());
    opcon.leftBumper().onTrue(intake.retractHopperVelocity());
    controller.leftBumper().or(controller.rightBumper()).onFalse(intake.retractStop());
