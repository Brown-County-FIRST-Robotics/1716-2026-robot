...
public class RobotContainer extends PeriodicRunnable {
  ...
  private void configureButtonBindings() {
    ...
    // Hood positions
    opcon.x().whileTrue(Commands.run(() -> shooter.quickServoCommand(0.1), shooter));
    opcon.y().whileTrue(Commands.run(() -> shooter.quickServoCommand(0.15), shooter));
    opcon.b().whileTrue(Commands.run(() -> shooter.quickServoCommand(0.2), shooter));
