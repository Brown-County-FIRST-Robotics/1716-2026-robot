...
public class ShooterIOKrakens implements ShooterIO {
  ...
  public ShooterIOKrakens(int motorID, int servoID) {
    ...
    configurator.apply(new ClosedLoopRampsConfigs().withDutyCycleClosedLoopRampPeriod(0.25));
    configurator.apply(
        new OpenLoopRampsConfigs()
            .withDutyCycleOpenLoopRampPeriod(1.0)
            .withVoltageOpenLoopRampPeriod(1.0));
  ...
  public void updateInputs(ShooterIOInputs inputs) {
    ...
    inputs.shooterHoodPosition = lastCommandedPos;
