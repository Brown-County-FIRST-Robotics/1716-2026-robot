...
public class Shooter extends SubsystemBase {
  ...
  private static final double hoodLegLength1 = 4.965;
  private static final double hoodLegLength2 = 6.128;
  private static final double hoodZero = 1.082;
  ...
  public void periodic() {
    ...
    Logger.recordOutput("hood", forwardKinematics(0));
