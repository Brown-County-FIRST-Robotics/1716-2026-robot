...
public class Drive extends SubsystemBase {
  ...
  private static final double ROBOT_MOI = 6.883; // moment of inertia
  private static final double WHEEL_COF = 1.4; // coefficiant of friction
  ...
  public void periodic() {
    ...
    // If the quest is connected, use that instead
    if (quest.isConnected()) poseEstimator.resetPose(quest.getPose());
