  ...
  public static Command joystickDrive(
    ...
    return Commands.run(
            () -> {
              ...
              ChassisSpeeds targetSpeedsFromController =
                  new ChassisSpeeds(
              ...
              if (!robotRelativeSupplier.getAsBoolean()) {
                ...
                if (drive.holdingAngle != HoldMode.OFF) {
                  targetSpeedsFromController.omegaRadiansPerSecond =
                ...
                if ((Math.abs(x) < DEADBAND
                  ...
                  targetSpeedsFromController.vxMetersPerSecond =
                      distanceControllerX.atGoal() ? 0 : pidX;
                } else {
                ...
                if ((Math.abs(y) < DEADBAND
                  ...
                  targetSpeedsFromController.vyMetersPerSecond =
                      distanceControllerY.atGoal() ? 0 : pidY;
                } else {
                  drive.holdingY = false;
                }

                targetSpeedsFromController =
              ...
              drive.runVelocity(targetSpeedsFromController);
            },
            drive)
        .beforeStarting(
            () -> {
