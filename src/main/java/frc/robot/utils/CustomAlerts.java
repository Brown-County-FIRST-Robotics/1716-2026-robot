...
public class CustomAlerts {
  ...
  //     */
  //    public CustomAlert(Alert.AlertType level, BooleanSupplier isActive, Supplier<String>
  // message) {
  //      super();
  ...
  //        Alert.AlertType.ERROR,
  //        () -> !navx.isConnected(),
  //        "Navx is not connected. This will cause pose estimation and field-oriented driving to
  // fail. ");
  //    new CustomAlert(
  //        Alert.AlertType.WARNING,
  //        navx::isCalibrating,
